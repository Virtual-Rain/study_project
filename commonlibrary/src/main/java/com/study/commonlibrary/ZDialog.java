package com.study.commonlibrary;
...
import com.study.commonlibrary.base.view.BaseDialogFragment;
 ...
 */
public class ZDialog extends BaseDialogFragment {

    private static final String KEY_TCONTROLLER = "ZController";
    protected ZController zController;
    private static volatile ZDialog mDialog;

    private static ZDialog getInstance() {
        if (null == mDialog) {
            synchronized (ZDialog.class) {
                if (null == mDialog) {
                    mDialog = new ZDialog();
                }
            }
...
//        if (null != zController.getDialogView()) {
//            zController.getDialogView().setZDialog(null);
//        }
    }
...
//        if (null != zController.getDialogView()) {
//            zController.getDialogView().setZDialog(this);
//        }
    }
    ...
    public static class Builder {
        ...
        public ZDialog create() {
            ZDialog dialog = params.mIsInstance ? ZDialog.getInstance() : new ZDialog();
