package com.study.commonlibrary.widget.verticalTabLayout.util;
...
public class TabFragment2Manager {
    private FragmentManager mManager;
    private int mContainerResid;
    private List<Fragment> mFragments;
    private VerticalTab2Layout mTabLayout;
    private VerticalTab2Layout.OnTabSelectedListener mListener;

    public TabFragment2Manager(FragmentManager manager, List<Fragment> fragments, VerticalTab2Layout tabLayout) {
    ...
    public TabFragment2Manager(FragmentManager manager, int containerResid, List<Fragment> fragments, VerticalTab2Layout tabLayout) {
    ...
    private class OnFragmentTabSelectedListener implements VerticalTab2Layout.OnTabSelectedListener {
