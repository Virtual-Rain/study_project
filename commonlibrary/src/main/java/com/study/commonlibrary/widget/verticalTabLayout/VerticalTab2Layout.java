package com.study.commonlibrary.widget.verticalTabLayout;
...
import com.study.commonlibrary.widget.verticalTabLayout.adapter.TabAdapter;
import com.study.commonlibrary.widget.verticalTabLayout.util.TabFragment2Manager;
import com.study.commonlibrary.widget.verticalTabLayout.view.QTabView;
...
import static com.study.commonlibrary.uitls.ScreenUtils.dp2px;

/**
 * 垂直TabLayout
 */
public class VerticalTab2Layout extends ScrollView {
    ...
    private TabFragment2Manager mTabFragmentManager;

    public VerticalTab2Layout(Context context) {
        this(context, null);
    }

    public VerticalTab2Layout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VerticalTab2Layout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_color_vertical,
                ContextCompat.getColor(context, R.color.colorAccent));
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_indicator_width, dp2px(context, 3));
        ...
        mIndicatorResId = typedArray.getResourceId(R.styleable.VerticalTabLayout_indicator_drawable, 0);
        ...
        mTabPaddingLeft = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_tab_padding_left, 0);
        mTabPaddingTop = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_tab_padding_top, 0);
...
//            ((QTabView)mSelectedTab).isNeayByChecked = true;
    ...
    public void setupWithFragment(FragmentManager manager, int containerResid, List<Fragment> fragments) {
        ...
        if (containerResid != 0) {
            mTabFragmentManager = new TabFragment2Manager(manager, containerResid, fragments, this);
        } else {
            mTabFragmentManager = new TabFragment2Manager(manager, fragments, this);
        }
    }
    ...
    public void setupWithViewPager(@Nullable ViewPager2 viewPager, OnTabSelectedListener tabSelectedListener) {
        if (mViewPager != null && mTabPageChangeListener != null) {
            mViewPager.registerOnPageChangeCallback(mTabPageChangeListener);
        }
    ...
    private void setPagerAdapter(@Nullable final RecyclerView.Adapter adapter, final boolean addObserver) {
