...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int SHADOW_COLOR = Color.argb(00, 255, 255, 255);
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f, Color.BLACK, Color.BLACK, Shader.TileMode.CLAMP));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPath.rewind();
        mPath.addRoundRect(new RectF(width - PADDING, height - PADDING, width - PADDING, height - PADDING), CORNER_RADIUS, CORNER_RADIUS, Path.Direction.CW);
