...
public interface ITabView {
    ...
    class TabTitle {
        ...
        public int getTitleGravity() {
            return mBuilder.mTitleGravity;
        }

        public boolean getTitleTextBold() {
            return mBuilder.mTitleTextBold;
        }

        public int getShadowColorSelected() {
            return mBuilder.mShadowColorSelected;
        }
        ...
        public static class Builder {
            ...
            private int mShadowColorSelected;
            ...
            public Builder() {
                ...
                this.mTitleGravity = Gravity.CENTER;
                this.mTitleTextBold = false;
                this.mShadowColorSelected = 0;
                this.mContent = "";
            }
            ...
            public Builder setTitleTextBold(boolean bold) {
                mTitleTextBold = bold;
                return this;
            }

            public Builder setShadowColorSelected(int color) {
                mShadowColorSelected = color;
                return this;
            }
