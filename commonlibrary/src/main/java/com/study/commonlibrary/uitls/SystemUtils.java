...
public class SystemUtils {
    ...
    private final static String[] MEIZUBOARD = {"m9", "M9", "mx", "MX", "msmnile"};
    private final static String[] BOTTOMNAVIGATION = {"COL", "ELE", "msmnile", "davinci", "sdm710"};
    private final static String[] NONEEDBOTTOMNAVIGATION = {"meizu", "oppo"};
    private final static String[] NEEDBOTTOMNAVIGATIONLESS = {"huawei", "vivo"};
    ...
    private static boolean isTabletPc(Context context) {
    ...
    public static boolean isTablet(Context context) {
        ...
        sIsTabletValue = isTabletPc(context);
     ...
     * @return
     */
    public static boolean isAddBottomNavigation() {
        return isPhone(BOTTOMNAVIGATION) && isNeedBottomNavigation(NONEEDBOTTOMNAVIGATION);
    }

    public static boolean isNeedBottomNavigationLess() {
        return !isNeedBottomNavigation(NEEDBOTTOMNAVIGATIONLESS);
    }
     ...
     * @return
     */
    private static boolean isNeedBottomNavigation(String[] brands) {
        if (null == brands) {
            return true;
        }
