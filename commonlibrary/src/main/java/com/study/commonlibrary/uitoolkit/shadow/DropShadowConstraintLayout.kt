 ...
 * [@2@.修改ViewGroup名字]
 */
class DropShadowConstraintLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int = 0, defStyleRes: Int = 0) : /*TODO [@2@.修改ViewGroup名字]*/ConstraintLayout/*TODO [@2@.修改ViewGroup名字]*/(context, attrs, defStyleAttr) {
    private val SHADOW_SOLID = 0
    private val SHADOW_BLUR = 1

    inner class DropShadowLayoutParam(c: Context, attributeSet: AttributeSet?) : /*TODO [@2@.修改ViewGroup名字]*/ConstraintLayout/*TODO [@2@.修改ViewGroup名字]*/.LayoutParams(c, attributeSet) {
    ...
    override fun generateLayoutParams(attrs: AttributeSet?): /*TODO [@2@.修改ViewGroup名字]*/ConstraintLayout/*TODO [@2@.修改ViewGroup名字]*/.LayoutParams {
